    ...
    return (
        <div className="bg-white p-3 rounded-lg">
            ...
            <div className="flex align-bottom justify-between items-center">
                ...
                <Link to={`/upcoming-camp-details/${_id}`} ><button className="py-2 font-semibold px-4 rounded-md text-white bg-theme-color flex items-center gap-2">Details<FaRegArrowAltCircleRight></FaRegArrowAltCircleRight></button></Link>
            </div>
        </div>
    )
}
